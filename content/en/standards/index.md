...
{{% blocks/feature icon="fab fa-chart-network" title="IETF" url="/docs/docs/standards/ietf" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="IANA" url="/docs/docs/standards/iana" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="W3c" url="/docs/docs/standards/w3c" %}}
...
{{% blocks/feature icon="fab fa-chart-network" title="HTTP 1.1" url="/docs/docs/standards/http" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="HTTP/2" url="/docs/docs/standards/http-20" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="HTTP/3" url="/docs/docs/standards/http-30" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="JSON Schema" url="/docs/docs/standards/json-schema" %}}
...
{{% blocks/feature icon="fab fa-chart-network" title="CSV" url="/docs/docs/standards/csv" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="JSON" url="/docs/docs/standards/json" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="XML" url="/docs/docs/standards/xml" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="YAML" url="/docs/docs/standards/yaml" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="HTML" url="/docs/docs/standards/html" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="Markdown" url="/docs/docs/standards/markdown" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="Avro" url="/docs/docs/standards/avro" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="Parquet" url="/docs/docs/standards/parquet" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="Protocol Buffers" url="/docs/docs/standards/protocol-buffers" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="JDBC" url="/docs/docs/standards/jdbc" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="ODBC" url="/docs/docs/standards/odbc" %}}
...
{{% blocks/feature icon="fab fa-chart-network" title="OpenAPI" url="/docs/docs/standards/openapi" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="Overlays" url="/docs/docs/standards/openapi-overlays" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="Arazzo" url="/docs/docs/standards/arazzo" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="AsyncAPI" url="/docs/docs/standards/asyncapi" %}}
...
{{% blocks/feature icon="fab fa-chart-network" title="Spectral" url="/docs/docs/standards/spectral" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="Vacuum" url="/docs/docs/standards/vacuum" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="Open Policy Agent (OPA)" url="/docs/docs/standards/open-policy-agent" %}}
...
{{% blocks/feature icon="fab fa-chart-network" title="Model Context Protocol (MCP)" url="/docs/docs/standards/spectral" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="Agent2Agent (A2A)" url="/docs/docs/standards/vacuum" %}}
...
{{% blocks/feature icon="fab fa-chart-network" title="Postman Collections" url="/docs/docs/standards/postman-collections" %}}
...
{{% blocks/feature icon="fab fa-chart-network" title="Bruno Collections" url="/docs/docs/standards/spectral" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="Open Collections" url="/docs/docs/standards/vacuum" %}}
The Agent2Agent (A2A) Protocol is an open standard for communication and interoperability among independent—often opaque—AI agent systems. Because agents may be built with different frameworks, languages, and vendors, A2A provides a common language and interaction model.
{{% /blocks/feature %}}
...
{{% blocks/feature icon="fab fa-chart-network" title="Postman Environments" url="/docs/docs/standards/postman-collections" %}}
...
{{% blocks/feature icon="fab fa-chart-network" title="Bruno Environments" url="/docs/docs/standards/spectral" %}}
...
{{% blocks/feature icon="fab fa-chart-network" title="OAuth 2.0" url="/docs/docs/standards/oauth-20" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="JWT" url="/docs/docs/standards/jwt" %}}
...
{{% blocks/feature icon="fab fa-chart-network" title="Schema.org" url="/docs/docs/standards/schema-org" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="JSON-LD" url="/docs/docs/standards/json-led" %}}
...
{{% blocks/feature icon="fab fa-chart-network" title="APIs.json" url="/docs/docs/standards/apis-json" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="API Commons" url="/docs/docs/standards/api-commons" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="Microcks Examples" url="/docs/docs/standards/microcks-examples" %}}
