...
## Capabilities
These are the capabilities we are currently developing out in the open to support storytelling and conversations, working through the business and technical details of each type of potential Naftiko Capability deployment, ensuring that we have capabilities ready when the Naftiko Framework, Engine, and Fabric are ready.

{{% /blocks/lead %}}

{{% blocks/section color="white" type="row" %}}

{{% blocks/feature icon="fab fa-chart-network" title="API Reusability" url="/docs/docs/capabilities/api-reusability" %}}
...
{{% blocks/feature icon="fab fa-puzzle-piece-simple" title="Manage Events" url="/docs/docs/capabilities/manage-events" %}}
