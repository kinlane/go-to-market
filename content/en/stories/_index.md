...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Capabilities Blog Post on API Evangelist" url="/docs/stories/capabilities-api-evangelist-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Blog Post Announcing Capabilities Podcast" url="/docs/stories/capabilities-podcast-naftiko-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Capabilities Blog Post on The New Stack" url="/docs/stories/capabilities-the-new-stack-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Blog Post on AI Context Use Case" url="/docs/stories/ai-context-use-case-naftiko-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Blog Post on API Reusability Use Case" url="/docs/stories/api-reusability-use-case-naftiko-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Blog Post on AI Orchestration Use Case" url="/docs/stories/ai-orchestration-use-case-naftiko-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Blog Post on Data Sovereignty Use Case" url="/docs/stories/data-sovereignty-use-case-naftiko-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Blog Post on SQL Data Access" url="/docs/stories/sql-data-acess-use-case-naftiko-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Blog Post on Cost" url="/docs/stories/cost-blog-post-naftiko-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Blog Post on Velocity" url="/docs/stories/velocity-blog-post-naftiko-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Blog Post on Risk" url="/docs/stories/risk-blog-post-naftiko-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Blog Post on Innovation" url="/docs/stories/innovation-blog-post-naftiko-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="API Evangelist Blog Post About Naftiko Signals" url="/docs/stories/naftiko-signals-program-api-evangelist-blog-post" %}}
...
{{% blocks/feature icon="fa-kit fa-stories-icon" title="Naftiko Blog Post About Naftiko Signals" url="/docs/stories/naftiko-signals-program-naftiko-blog-post" %}}
This is blog post announcing the Naftiko Signals program on the Naftiko Blog, providing an official line in the sand for when we started the program, while we are still building it out in the public, helping share the backstory, the data, and bring in more design, service, and market partners to help us invest in the research.
{{% /blocks/feature %}}

{{% blocks/feature icon="fa-kit fa-stories-icon" title="Naftiko Blog Post on White Paper" url="/docs/stories/naftiko-signals-white-paper-naftiko-blog-post" %}}
