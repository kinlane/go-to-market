...
{{% blocks/feature icon="fab fa-kit fa-naftiko-monogram" title="Naftiko" url="/docs/docs/channels/naftiko-blog" %}}
...
{{% blocks/feature icon="fab fa-kit fa-api-icon" title="API Evangelist" url="/docs/docs/channels/api-evangelist" %}}
...
{{% blocks/feature icon="fab fa-kit fa-medium-icon" title="Medium" url="/docs/docs/channels/medium" %}}
...
{{% blocks/feature icon="fab fa-kit fa-linkedin-svgrepo-com" title="LinkedIn" url="/docs/docs/channels/linkedin" %}}
...
{{% blocks/feature icon="fab fa-kit fa-bluesky-icon" title="Bluesky" url="/docs/docs/channels/bluesky" %}}
...
{{% blocks/feature icon="fa-kit fa-reddit-icon" title="Reddit" url="/docs/docs/channels/reddit" %}}
...
{{% blocks/feature icon="fa-kit fa-hacker-news-svgrepo-com" title="Hacker News" url="/docs/docs/channels/hacker-news" %}}
...
{{% blocks/feature icon="fa-kit-duotone fa-dailydev-icon" title="Daily.Dev" url="/docs/docs/channels/daily-dev" %}}
...
{{% blocks/feature icon="fa-solid fa-tv" title="Dev.to" url="/docs/docs/channels/dev-to" %}}
...
{{% blocks/feature icon="fa-kit fa-youtube-icon" title="Youtube" url="/docs/docs/channels/youtube" %}}
...
{{% blocks/feature icon="fa-kit fa-apple-svgrepo-com" title="Apple Podcasts" url="/docs/docs/channels/apple-podcasts" %}}
...
{{% blocks/feature icon="fa-kit fa-spotify-icon" title="Spotify Podcasts" url="/docs/docs/channels/spotify" %}}
...
{{% blocks/feature icon="fa-solid fa-tv" title="Gartner" url="/docs/docs/channels/gartner" %}}
...
{{% blocks/feature icon="fa-solid fa-tv" title="G2" url="/docs/docs/channels/g2" %}}
...
{{% blocks/feature icon="fa-solid fa-tv" title="Crunchbase" url="/docs/docs/channels/crunchbase" %}}
