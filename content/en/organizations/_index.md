...
{{% blocks/feature icon="fa-solid fa-sitemap" title="IETF" url="/docs/docs/standards/ietf" %}}
...
{{% blocks/feature icon="fa-solid fa-sitemap" title="IANA" url="/docs/docs/standards/iana" %}}
...
{{% blocks/feature icon="fa-solid fa-sitemap" title="W3c" url="/docs/docs/standards/w3c" %}}
...
{{% blocks/feature icon="fa-solid fa-sitemap" title="Linux Foundation" url="/docs/docs/standards/linux-foundation" %}}
...
{{% blocks/feature icon="fa-solid fa-sitemap" title="Apache Foundation" url="/docs/docs/standards/apache-foundation" %}}
...
{{% blocks/feature icon="fa-solid fa-sitemap" title="CNCF" url="/docs/docs/standards/cncf" %}}
